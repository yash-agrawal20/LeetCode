//https://leetcode.com/problems/ugly-number-ii/discuss/1271546/C%2B%2B-solution-with-explaination-(DP)-approach
...
public:
    int nthUglyNumber(int n) {
        ...
        for(int i =2; i<= n ; i++){
            ...
            int f3 = 3* dp[p3];
            int f5 = 5* dp[p5];
            int min_ = min(f5, min(f2, f3)); // find the min  of all 
